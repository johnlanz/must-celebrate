...
interface VercelOrderPickupProps {
  username?: string;
  userImage?: string;
...
export const VercelOrderPickup = ({
  username,
  userImage,
  invitedByUsername,
  invitedByEmail,
        ...
        <Body className="bg-gray-100 p-6">
          <Container className="bg-white p-6 rounded-lg shadow-md mx-auto">
            ...
            <Text className="text-gray-700 mb-6">
              We are pleased to let you know that your order is now ready for pickup. Please go to the counter to collect your order.
              Below you'll find a summary of your order and pickup details.
            </Text>
...
VercelOrderPickup.PreviewProps = {
  username: 'alanturing',
...
} as VercelOrderPickupProps;

export default VercelOrderPickup;
