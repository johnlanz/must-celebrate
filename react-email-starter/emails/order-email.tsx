...
interface VercelOrderEmailProps {
  username?: string;
  userImage?: string;
        ...
        <Body className="bg-gray-100 p-6">
          <Container className="bg-white p-6 rounded-lg shadow-md mx-auto">
            ...
            <Text className="text-gray-700 mb-6">
              We have received your order from Shamrock Address for Pickup on 15/06/2025 7:41:10 PM.
            </Text>
...
} as VercelOrderEmailProps;

export default VercelOrderEmail;
